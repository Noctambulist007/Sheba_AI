...
class _CustomFormFieldState extends State<CustomFormField> {
  ...
  Widget build(BuildContext context) {
    ...
    final enabledBorder = _getInputBorder(AppColors.grayscaleBorderDisabled);
    final focusedBorder = _getInputBorder(AppColors.primaryColour);
    ...
    return FormBuilderTextField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: AppColors.grayscaleSurfaceInputBG,
