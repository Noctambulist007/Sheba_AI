...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LivesUiState);
}
...
/// @nodoc
class $LivesUiStateCopyWith<$Res>  {
$LivesUiStateCopyWith(LivesUiState _, $Res Function(LivesUiState) __);
}


/// Adds pattern-matching-related methods to [LivesUiState].
extension LivesUiStatePatterns on LivesUiState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( Lives lives)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case InitialState() when initial != null:
return initial();case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
return success(_that.lives);case ErrorState() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( Lives lives)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case InitialState():
return initial();case LoadingState():
return loading();case SuccessState():
return success(_that.lives);case ErrorState():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( Lives lives)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case InitialState() when initial != null:
return initial();case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
...
class InitialState implements LivesUiState {
  const InitialState();
...
class LoadingState implements LivesUiState {
  const LoadingState();
...
class SuccessState implements LivesUiState {
  const SuccessState(this.lives);
  

 final  Lives lives;

/// Create a copy of LivesUiState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SuccessState&&(identical(other.lives, lives) || other.lives == lives));
}


@override
int get hashCode => Object.hash(runtimeType,lives);

@override
String toString() {
  return 'LivesUiState.success(lives: $lives)';
}
...
/// @nodoc
abstract mixin class $SuccessStateCopyWith<$Res> implements $LivesUiStateCopyWith<$Res> {
...
/// Create a copy of LivesUiState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? lives = null,}) {
  return _then(SuccessState(
null == lives ? _self.lives : lives // ignore: cast_nullable_to_non_nullable
as Lives,
  ));
}
...
class ErrorState implements LivesUiState {
...
@override
String toString() {
  return 'LivesUiState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorStateCopyWith<$Res> implements $LivesUiStateCopyWith<$Res> {
