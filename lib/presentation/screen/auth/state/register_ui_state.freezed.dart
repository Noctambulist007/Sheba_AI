...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterUiState);
}
...
/// @nodoc
class $RegisterUiStateCopyWith<$Res>  {
$RegisterUiStateCopyWith(RegisterUiState _, $Res Function(RegisterUiState) __);
}


/// Adds pattern-matching-related methods to [RegisterUiState].
extension RegisterUiStatePatterns on RegisterUiState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( Register register)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case InitialState() when initial != null:
return initial();case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
return success(_that.register);case ErrorState() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( Register register)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case InitialState():
return initial();case LoadingState():
return loading();case SuccessState():
return success(_that.register);case ErrorState():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( Register register)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case InitialState() when initial != null:
return initial();case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
...
class InitialState implements RegisterUiState {
  const InitialState();
...
@override
String toString() {
  return 'RegisterUiState.initial()';
}
...
class LoadingState implements RegisterUiState {
  const LoadingState();
...
@override
String toString() {
  return 'RegisterUiState.loading()';
}
...
class SuccessState implements RegisterUiState {
  const SuccessState({required this.register});
  

 final  Register register;

/// Create a copy of RegisterUiState
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SuccessState&&(identical(other.register, register) || other.register == register));
}
...
@override
String toString() {
  return 'RegisterUiState.success(register: $register)';
}
...
/// @nodoc
abstract mixin class $SuccessStateCopyWith<$Res> implements $RegisterUiStateCopyWith<$Res> {
...
class ErrorState implements RegisterUiState {
...
@override
String toString() {
  return 'RegisterUiState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorStateCopyWith<$Res> implements $RegisterUiStateCopyWith<$Res> {
