...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoginUiState);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( TokenData tokenData)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case InitialState() when initial != null:
return initial();case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
return success(_that.tokenData);case ErrorState() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( TokenData tokenData)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case InitialState():
return initial();case LoadingState():
return loading();case SuccessState():
return success(_that.tokenData);case ErrorState():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( TokenData tokenData)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case InitialState() when initial != null:
return initial();case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
...
class InitialState implements LoginUiState {
  const InitialState();
...
class LoadingState implements LoginUiState {
  const LoadingState();
...
class SuccessState implements LoginUiState {
  const SuccessState({required this.tokenData});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SuccessState&&(identical(other.tokenData, tokenData) || other.tokenData == tokenData));
}
...
/// @nodoc
abstract mixin class $SuccessStateCopyWith<$Res> implements $LoginUiStateCopyWith<$Res> {
...
class ErrorState implements LoginUiState {
...
@override
String toString() {
  return 'LoginUiState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class $ErrorStateCopyWith<$Res> implements $LoginUiStateCopyWith<$Res> {
